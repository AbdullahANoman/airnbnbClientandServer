...
import CheckIn from "../../Components/CheckInandOut/CheckInandOut";
import AddGuest from "../../Components/AddGuest/AddGuest";
import { getRooms } from "../../api/roomApi";
import { formateDate } from "../../utils/dateCovert";
...
const NavForms = ({ setRooms, setIsOpen }) => {
  ...
  const [count, increaseGuestCount] = useState(null);
  ...
  return (
    <>
      ...
      <div className="z-50">
        ...
        {find == "checkIn" && <CheckIn props={props} />}
        {find == "checkOut" && <CheckIn props={props} />}
        {find == "guest" && (
          <AddGuest
